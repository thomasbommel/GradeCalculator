...
import static model.database.utils.DataBaseField.DataBaseFieldType.BOOLEAN;
import static model.database.utils.DataBaseField.DataBaseFieldType.TEXT;
import static model.database.utils.DataBaseField.Modifiers.DEFAULT;
import static model.database.utils.DataBaseField.Modifiers.NOT_NULL;
import static model.database.utils.DataBaseField.Modifiers.TRUE;
...
public class UserTable implements DataBaseTable<User>{
    ...
    public void deleteFromDataBase(SQLiteDatabase db, User user) {
        SchoolYearTable.deleteFromDataBaseForUser(db,user);
